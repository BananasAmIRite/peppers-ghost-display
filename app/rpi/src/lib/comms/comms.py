...
SPOTIFY_SET_LYRICS = 0x43

# PI BYPASS COMMANDS (these messages will be sent as [PI_MSG, PI_CMD, ...PAYLOAD]) pass through esp32, and emerge in the same way
PI_MSG = 0x50

# (PI_BYPASS COMMANDS OFFSET)
PI_SWIPE = 0x00
PI_ADD_TMP_SCRN = 0x01
PI_ADD_TMP_NTF = 0x02
PI_RMV_TMP_SCRN = 0x03

# CALENDAR
CAL_SET_DATE_TIME = 0x60 
CAL_SET_EVENTS = 0x61
